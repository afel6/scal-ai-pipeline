...
if 'robust_extract_scal' not in content:
    with open('scal_file_handler.py', 'a', encoding='utf-8') as f:
        f.write('\n' + new_code + '\n')
    print('Functions appended to scal_file_handler.py')
else:
    print('robust_extract_scal already exists.')
