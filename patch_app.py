...
# Define replacement
import_statement = """import json as _json, logging, threading, asyncio
                import json as _json_diag"""

replacement_import_statement = """import json as _json, logging, threading, asyncio
                import json as _json_diag
from core.json_utils import salvage_and_clean_json, merge_and_deduplicate_sweeps"""

content = content.replace(import_statement, replacement_import_statement)


salvage_def = """        def salvage_and_clean_json(text_to_parse: str) -> list:
            parsed = None
            try:
...
content = content.replace(salvage_def, "")


merge_def = """        def merge_and_deduplicate_sweeps(samples):
...
content = content.replace(merge_def, "")

content = content.replace("extracted_json = salvage_and_clean_json(clean_text)", "extracted_json = salvage_and_clean_json(clean_text, phase0b_inventory)")
