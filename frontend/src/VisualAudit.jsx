...
const ScannerLine = () => (
  <div className="absolute inset-0 pointer-events-none z-10 overflow-hidden rounded-none-[2rem]">
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-[#050505] overflow-hidden">
      ...
      <div className="p-4 md:p-6 border-b border-yellow-900/20 bg-black/60 backdrop-blur-md">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-none bg-yellow-500/10 flex items-center justify-center border border-yellow-500/20 shadow-[0_0_20px_rgba(234,179,8,0.15)] relative group">
              <Camera className="w-6 h-6 text-yellow-500 group-hover:scale-110 transition-transform" />
              <div className="absolute -top-1 -right-1 w-3 h-3 bg-green-500 border-2 border-black rounded-none animate-pulse" />
            </div>
            <div>
              ...
              <div className="flex items-center gap-2 mt-0.5">
                ...
                <span className="w-1 h-1 bg-slate-700 rounded-none" />
      ...
      <div className="flex-1 overflow-y-auto p-4 md:p-8 space-y-8 custom-scrollbar">
        {!isResultMode && (
          <div className="max-w-4xl mx-auto space-y-6">
            <div 
              ...
              className={`relative aspect-video md:aspect-[21/9] rounded-none-[2rem] border-2 border-dashed transition-all flex flex-col items-center justify-center cursor-pointer group overflow-hidden
                ...
                <>
                  ...
                  {!scanning && (
                    <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity">
                      <div className="w-14 h-14 rounded-none bg-yellow-500 flex items-center justify-center text-black shadow-2xl shadow-yellow-500/40 scale-90 group-hover:scale-100 transition-transform duration-500">
                        <Upload className="w-6 h-6" />
                      </div>
                      <span className="text-[11px] font-black text-yellow-500 mt-4 uppercase tracking-[0.2em] bg-black/60 px-4 py-2 rounded-none border border-yellow-500/20">Replace Capture</span>
                    </div>
                  )}
                </>
              ) : (
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <div className="md:col-span-3 space-y-3">
                <textarea 
                  ...
                  className="w-full bg-[#111116] border border-slate-800 rounded-none-[1.5rem] px-6 py-4 text-sm text-slate-300 outline-none focus:border-yellow-500/50 min-h-[100px] resize-none"
                />
              </div>
              <button 
                onClick={runAudit}
                disabled={!file || loading}
                className={`w-full rounded-none-[1.5rem] font-black text-[10px] uppercase tracking-[0.3em] flex flex-col items-center justify-center gap-2
        ...
        {(result || scanning) && (
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="relative p-8 rounded-none-[2rem] bg-[#0c0c10] border border-yellow-900/20 shadow-2xl">
