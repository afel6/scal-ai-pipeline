...
const KrTooltip = ({ active, payload, label, xLabel }) => {
  ...
  return (
    <div className="bg-[#080810]/98 backdrop-blur-2xl border border-white/10 rounded-none
        ...
        return (
          <div key={i} className="flex items-center justify-between gap-6 mb-2 last:mb-0">
            <div className="flex items-center gap-2">
              {isLab ? (
                <div className="w-2.5 h-2.5 rounded-none border border-[#080810]"
                     style={{ backgroundColor: entry.color }} />
              ) : (
                <div className="w-4 h-0.5 rounded-none" style={{ backgroundColor: entry.color }} />
              )}
...
const ValidationBadge = ({ validation }) => {
  ...
  return (
    <div className="relative">
      <button
        onClick={() => setOpen(o => !o)}
        className={`flex items-center gap-2 px-3 py-1.5 rounded-none border text-[10px] font-black
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 z-50 w-80 bg-[#0c0c14]/98
                        border border-white/10 rounded-none p-4 shadow-2xl shadow-black/80
...
const ParamPanel = ({ fit_params, endpoints, archie, jfunction }) => {
  ...
  if (archie) {
    ...
    return (
      <div className="mt-6">
        <div className="bg-[#0a0a0f] border border-white/5 rounded-none p-4 max-w-xs">
  ...
  return (
    <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
      <div className="bg-[#0a0a0f] border border-white/5 rounded-none p-4">
...
export default function KrCurvePlot({ plotData }) {
  ...
  if (!data?.curves) {
    return (
      <div className="p-10 bg-red-950/10 border border-red-900/30 rounded-none text-red-400 text-xs font-mono flex flex-col items-center gap-4">
  ...
  return (
    <div className="my-10 rounded-none-[2.5rem] border border-white/5 bg-[#04040a] shadow-[0_40px_80px_-20px_rgba(0,0,0,0.95)] overflow-hidden">
      <div className="px-8 pt-8 pb-6 border-b border-white/5 bg-gradient-to-b from-white/[0.025] to-transparent">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            <div className="flex items-center gap-3 mb-2">
              <div className="p-2 rounded-none bg-sky-500/10 border border-sky-500/20">
          ...
          <div className="flex flex-wrap items-center gap-2">
            {validation.wettability && (
              <div className={`flex items-center gap-2 px-3 py-1.5 rounded-none border text-[10px] font-black uppercase tracking-widest ${wettConfig.bg} ${wettConfig.border}`} style={{ color: wettConfig.color }}>
                <div className="w-2 h-2 rounded-none animate-pulse" style={{ backgroundColor: wettConfig.color }} />
                {wettConfig.label}
              </div>
            )}
        ...
        {crossover.Sw != null && (
          <div className="mt-4 inline-flex items-center gap-3 px-4 py-2 bg-white/[0.03] border border-white/8 rounded-none text-[11px] font-mono">
        ...
        {(xLog || yLog) && (
          <div className="mt-3 flex items-center gap-2 text-[9px] font-mono text-slate-600 uppercase tracking-widest">
            <span className="px-2 py-0.5 rounded-none bg-white/5 border border-white/5">LOG-LOG AXES</span>
          ...
          {data.curves.map((curve, idx) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2.5 rounded-none px-2 py-1 transition-all
              ...
              >
                {curve.showLine !== false ? (
                  ...
                  <div className="w-3 h-3 rounded-none border-2 border-[#04040a]"
