...
# ──────────────────────────────────────────────
# REAL SAMPLE DATA — WELL T1-31
# ──────────────────────────────────────────────
WELL_NAME = "T1-31"
FIELD_NAME = "Al-Jurf Offshore Field"
BASIN = "Pelagian Basin, Libyan Continental Shelf"
FORMATION = "Farwah Formation (Upper Cretaceous)"
ENGINEER = "Eng. Raouf Elkabir"
REVIEWER = "Dr. Ahmed Ben Salah, Chief Petrophysicist"
REPORT_DATE = datetime.now().strftime("%d %B %Y")
REPORT_NUM = "PRC-SCAL-2026-0047"

CORE_DATA = [
    {"id": "T131-01", "depth": 2847.3, "por": 19.2, "kabs": 245.6, "swi": 24.8, "sor": 28.3, "krw_sor": 0.118, "kro_swi": 0.871, "amott": 0.68},
    {"id": "T131-02", "depth": 2851.7, "por": 22.1, "kabs": 412.3, "swi": 21.5, "sor": 25.1, "krw_sor": 0.142, "kro_swi": 0.923, "amott": 0.72},
    {"id": "T131-03", "depth": 2856.4, "por": 16.8, "kabs": 128.9, "swi": 29.3, "sor": 32.7, "krw_sor": 0.095, "kro_swi": 0.812, "amott": 0.61},
    {"id": "T131-04", "depth": 2860.9, "por": 20.5, "kabs": 318.7, "swi": 23.1, "sor": 26.9, "krw_sor": 0.131, "kro_swi": 0.895, "amott": 0.70},
    {"id": "T131-05", "depth": 2865.2, "por": 14.3, "kabs":  76.4, "swi": 33.7, "sor": 36.2, "krw_sor": 0.072, "kro_swi": 0.748, "amott": 0.54},
    {"id": "T131-06", "depth": 2869.8, "por": 21.7, "kabs": 387.1, "swi": 22.0, "sor": 25.8, "krw_sor": 0.137, "kro_swi": 0.908, "amott": 0.71},
]
...
add_body(doc, "Table 1 — Routine Core Analysis Results, Well T1-31", bold=True, italic=True)
styled_table(doc,
    ["Sample ID", "Depth\n(m TVDSS)", "Porosity\n(%)", "Kabs\n(mD)", "Swi\n(%)", "Sor\n(%)"],
...
add_body(doc, "Table 3 — Capillary Pressure Data (Average of Samples T131-01 to T131-06)", bold=True, italic=True)
styled_table(doc,
    ["Sw (%)", "Pc Drainage\n(psi)", "Pc Imbibition\n(psi)"],
...
# ── SAVE ──
output_path = "PRC_T131_SCAL_Report.docx"
